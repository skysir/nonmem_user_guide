...
$ABBR FUNCTION bernoullilogit(VQI,10)
$ABBR VECTOR VV(10)
$INPUT  AMT TVAL DV
$DATA  rsampler.csv
...
VV(1)=1.0
VV(2)=LAMBDA
" CALL bernoullilogit_RNG(2,VV)
Y=VV(1)
DV=Y
ELSE
VQI(1)=DV
VQI(2)=LAMBDA
WW=bernoullilogit(VQI)
Y=2.0*WW
ENDIF
...
$COVR
$TABLE TVAL DV NOAPPEND NOPRINT FILE=ran_bernoullilogit.tab
...
1
 ...
 RAW OUTPUT FILE (FILE): ran_bernoullilogit.ext
...
0ITERATION NO.:    0    OBJECTIVE VALUE:   5537.79468585099        NO. OF FUNC. EVALS.:   2
 CUMULATIVE NO. OF FUNC. EVALS.:        2
 NPARAMETR:  2.5000E+00
 PARAMETER:  1.0000E-01
 GRADIENT:   1.6754E+02
 
0ITERATION NO.:    4    OBJECTIVE VALUE:   5536.22266144899        NO. OF FUNC. EVALS.:   9
 CUMULATIVE NO. OF FUNC. EVALS.:       11
 NPARAMETR:  2.4532E+00
 PARAMETER:  8.1113E-02
 GRADIENT:  -1.4254E-01
...
0MINIMIZATION SUCCESSFUL
 ...
 OBJECTIVE FUNCTION VALUE WITHOUT CONSTANT:    5536.22266144899     
 OBJECTIVE FUNCTION VALUE WITH CONSTANT:       5536.22266144899     
