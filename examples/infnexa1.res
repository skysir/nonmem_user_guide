Mon 09/30/2013 
06:27 PM
; THIS IS THE FULL CONTROL STREAM FOR HELP FILE infn1.exa
$PROB  THEOPHYLLINE   POPULATION DATA
$INPUT      ID DOSE=AMT TIME CP=DV WT MISS
$DATA       THEOPPMV

$SUBROUTINES  ADVAN2 INFN=infnsub.f90
...
$SIGMA  .4
$TABLE ID DOSE TIME CP WT NOAPPEND FILE=THEOPPexa1
...
0LABELS FOR DATA ITEMS:
 ID DOSE TIME CP WT MISS EVID MDV
0FORMAT FOR DATA:
 (6E6.0,2F2.0)
