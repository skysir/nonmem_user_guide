 ...
 USAGE:
      USE ROCM_REAL, ONLY: F=>FL1,G=>GL1,G2=>GGL1,H=>HL1

 GLOBAL DECLARATION:
      USE SIZES, ONLY: NO,LVR,LVR2,DPSIZE
      REAL(KIND=DPSIZE) :: FL1(NO),GL1(NO,LVR), &
                           GGL1(NO,LVR2*(LVR2+1)/2), &
                           HL1(NO,LVR*LVR/4+LVR/2)

 DISCUSSION:

 These variables changes values with each individual record.  They  may
 be used by CONTR.
